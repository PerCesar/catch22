...
* [Validation](https://docs.spring.io/spring-boot/docs/2.7.5-SNAPSHOT/reference/htmlsingle/#io.validation)
...
* [Thymeleaf](https://docs.spring.io/spring-boot/docs/2.7.5-SNAPSHOT/reference/htmlsingle/#web.servlet.spring-mvc.template-engines)
